<nav class="navbar navbar-expand-lg bg-primary">
  <div class="container-fluid">
    <a class="navbar-brand link-light" href="/">GuaviareDirectory</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link link-light" href="/categories">Categorias</a>
        </li>

        <li class="nav-item">
          <a class="nav-link link-light" href="/offers">Ofertas</a>
        </li>
